...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('asset/css/seller/orderSeller.css')}}">
        ...
        <head>
            ...
            <div class="background-head-2">
                <div class="box">
                    ...
                    <div class="detail-2">
                        <h2>Informasi ongkir:</h2>
                        <div class="button-main">
                            <input type="text" placeholder="Masukkan biaya ongkos kirim" class="form-control-1" name="email">
                            <button class="button-1">Simpan</button>
                        </div>
                    </div>
                    <div class="detail-3">
